...
class LifeGameVisualizer:
    ...
    def _drawBackground(self):
        ...
        for icol in range(self.life.ncols):
            pygame.draw.line(self.screen, (0, 0, 0), (icol * self.CELL_SIZE, 0), (icol * self.CELL_SIZE, self.screen_height))
        for irow in range(self.life.nrows):
            pygame.draw.line(self.screen, (0, 0, 0), (0, irow * self.CELL_SIZE), (self.screen_width, irow * self.CELL_SIZE))
